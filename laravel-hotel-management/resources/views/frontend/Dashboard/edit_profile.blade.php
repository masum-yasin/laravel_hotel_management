...
<div class="col-lg-12 col-md-6">
    <div class="form-group">
       ...
       <img id="showImage" src="{{(!empty($profileData->photo)) ? url('upload/user_images/'. $profileData->photo) : url('upload/no_image.jpg')}}" class="rounded-circle p-1 bg-primary" alt="" width="120px">
    </div>
</div>
