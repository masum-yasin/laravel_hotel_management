    ...
    <div class="container">
        ...
        <div class="row pt-45">
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <a href="blog-details.html">
                        <img src="frontend/assets/img/blog/blog-item-img1.jpg" alt="Images">
                    </a>
                    <div class="content">
                        <ul>
            ...
            <div class="col-lg-4 col-md-6">
                <div class="blog-item">
                    <a href="blog-details.html">
                        <img src="frontend/assets/img/blog/blog-item-img2.jpg" alt="Images">
                    </a>
                    <div class="content">
                        <ul>
            ...
            <div class="col-lg-4 col-md-6 offset-lg-0 offset-md-3">
                <div class="blog-item">
                    <a href="blog-details.html">
                        <img src="frontend/assets/img/blog/blog-item-img3.jpg" alt="Images" style="height:280px">
                    </a>
                    <div class="content">
                        <ul>
