                        ...
                        <div class="col-lg-5 col-md-4 p-0">
                            <div class="room-card-img">
                                <a href="room-details.html">
                                    <img src="frontend/assets/img/room/room-style-img1.jpg" alt="Images">
                                </a>
                            </div>
                        </div>
                ...
                <div class="room-card-two">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-4 p-0">
                            <div class="room-card-img">
                                <a href="room-details.html">
                                    <img src="frontend/assets/img/room/room-style-img2.jpg" alt="Images">
                                </a>
                            </div>
                        </div>
                ...
                <div class="room-card-two">
                    <div class="row align-items-center">
                        <div class="col-lg-5 col-md-4 p-0">
                            <div class="room-card-img">
                                <a href="room-details.html">
                                    <img src="frontend/assets/img/room/room-style-img4.jpg" alt="Images">
                                </a>
                            </div>
                        </div>
