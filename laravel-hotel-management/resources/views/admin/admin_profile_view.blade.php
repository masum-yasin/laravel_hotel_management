                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                    <input type="file" name="address" class="form-control" id="image" />
                                </div>
                            </div>
                            <div class="row mb-3">
                                <div class="col-sm-3">
                                ...
                                <div class="col-sm-9 text-secondary">
                                  <img id="showImage" src="{{(!empty($adminData->photo)) ? url('upload/admin_images'.$adminData->photo) : url('upload/no_image.jpg')}}" class="rounded-circle p-1 bg-primary" alt="" width="120px">
                                </div>
                            </div>
                            <div class="row">
