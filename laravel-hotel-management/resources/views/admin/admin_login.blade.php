									...
									<div class="form-body">
										<form class="row g-3" method="POST" action="{{ route('login') }}">
											...
											<div class="col-12">
												...
												<input type="text" class="form-control" id="login" placeholder="jhon@example.com" name="login" @error('login') is-invalid
													@enderror>
													@error('login')
											...
											<div class="col-12">
												...
												<div class="input-group" id="show_hide_password">
													<input type="password" class="form-control border-end-0" id="password" value="12345678" placeholder="Enter Password" name="password" @error('password')
														is-invalid
